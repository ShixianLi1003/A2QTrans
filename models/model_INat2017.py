...
class Encoder(nn.Module):
    ...
    def forward(self, hidden_states, mask=None):
        ...
        for layer_block in self.layer[:10]:
        ...
        return encoded, attn_weights, total_threshold_loss
...
class Transformer(nn.Module):
    ...
    def forward(self, input_ids, mask=None):
        ...
        encoded, attn_weights, total_threshold_loss = self.encoder(embedding_output, mask)
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, labels=None, mask=None):
        x, attn_weights, threshold_loss = self.transformer(x, mask)
        ...
        if labels is not None:
            ...
            if self.contr_loss:
                ...
                loss = ce_loss + contrast_loss + threshold_loss  
            else:
